...
class Sale < ApplicationRecord
  ...
  class << self
    def request_headers
      HEADERS.merge('X-Parse-Session-Token' => AuthenticationService.fetch_token('benamram119@walla.com', 'Guy1986!'))
    end
    ...
    def sale_detail_request_body(object_id)
      {
        ...
        _SessionToken: AuthenticationService.fetch_token('benamram119@walla.com', 'Guy1986!')
      }
    end
