...
def fetch_object_id_and_status(client_number)
  ...
  body = {
    ...
    "limit": 1,
    "_method": "GET",
    "_ApplicationId": "aaaaaaag685a766578077b27f97885e11268d7f5",
    "_JavaScriptKey": "cf16854538d99be61530665d373cd693",
    "_ClientVersion": "js1.10.1",
    "_SessionToken": "r:62354480642919fb924aef7e8195bc85"
  }.to_json
...
def update_phone_number(object_id, new_phone_number, existing_comment)
  ...
  body = {
    ...
    "LeadStatusId" => { "__type" => "Pointer", "className" => "LeadStatuses", "objectId" => "xqiARVmH4w" },
    "_method" => "PUT",
    "_ApplicationId" => "aaaaaaag685a766578077b27f97885e11268d7f5",
    "_JavaScriptKey" => "cf16854538d99be61530665d373cd693",
    "_ClientVersion" => "js1.10.1",
...
CSV.foreach('morgage_leads.csv', headers: true, encoding: 'UTF-8') do |row|
